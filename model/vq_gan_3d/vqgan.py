...
class VQGAN(pl.LightningModule):
    ...
    def forward(self, x, optimizer_idx=None, log_image=False):
        ...
        if optimizer_idx == 0:
            ...
            disc_factor = adopt_weight(
                self.global_step, threshold=self.cfg.discriminator_iter_start)
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Zero gradients, backpropagate, and update generator parameters
        opt_ae.zero_grad()
        ...
        # Optionally, you can return a combined loss for logging purposes
        return {'loss_gen': loss_gen, 'loss_disc': discloss}
