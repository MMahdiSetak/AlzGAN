...
def run(cfg: DictConfig):
    ...
    data_loader = DataLoader('dataset/mri_pet_label.hdf5', bs)
    train_dataloader = data_loader.pet_generator(bs, "train")
    val_dataloader = data_loader.pet_generator(bs, "val")
